    ...
    return (
        <>
            <style>{`
                ...
                .heatmap-side-value.red {
                    color:#E24B4A;
                }

                .heatmap-side-value.blue {
                    color:#2563eb;
                }
                                    ...
                                    <div className="heatmap-cell-footer">
                                        <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                                            <div className="heatmap-cell-row">
                                                ...
                                                <span className="heatmap-fake-val">
                                                    {frame.fake_prob.toFixed(2)}%
                                                </span>
                                            </div>
                                            <div className="heatmap-cell-row">
                                                <span className="heatmap-real-label">실제 영상</span>
                                                <span className="heatmap-real-val">
                                                    {frame.real_prob.toFixed(2)}%
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        {selectedFrame && (
                            <div className="heatmap-gallery-preview">
                                <div className="heatmap-preview-card">
                                    ...
                                    <div className="heatmap-frame-badge">
                                        Frame {selectedFrame.frame_idx}
                                    </div>
                                    ...
                                    <div className="heatmap-cell-footer">
                                        <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                                            <div className="heatmap-cell-row">
                                                <span className="heatmap-fake-label">AI 생성</span>
                                                <span className="heatmap-fake-val">
                                                    {selectedFrame.fake_prob.toFixed(2)}%
                                                </span>
                                            </div>
                                            <div className="heatmap-cell-row">
                                                <span className="heatmap-real-label">실제 영상</span>
                                                <span className="heatmap-real-val">
                                                    {selectedFrame.real_prob.toFixed(2)}%
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="heatmap-preview-side">
                                    <div className="heatmap-side-top">
                                        ...
                                        <h5 className="heatmap-side-title">
                                            Frame {selectedFrame.frame_idx} 상세 정보
                                        </h5>
                                        <span className="heatmap-side-risk">
                                            위험도: {selectedFrame.risk}
                                        </span>
                                    </div>
                                    ...
                                    <div className="heatmap-side-info">
                                        <div className="heatmap-side-box">
                                            ...
                                            <div className="heatmap-side-value red">
                                                {selectedFrame.fake_prob.toFixed(2)}%
                                            </div>
                                        </div>
                                        ...
                                        <div className="heatmap-side-box">
                                            ...
                                            <div className="heatmap-side-value blue">
                                                {selectedFrame.real_prob.toFixed(2)}%
                                            </div>
                                        </div>
            ...
            chartInstance.current = new window.Chart(ctx, {
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        tooltip: {
                            callbacks: {
                                label: (c) => ` 위조 확률: ${c.parsed.y.toFixed(2)}%`,
                            },
                        },
                    },
                    scales: {
    ...
    return (
        <div style={{ minHeight: "100vh", background: "#f8fafc", fontFamily: "inherit" }}>
            <style>{`
                ...
                .fg-stat-value.danger {
                    color:#E24B4A;
                }
            `}</style>

            <div className="fg-header">
                <button className="fg-back-btn" onClick={onBack}>
                    ← 결과 리포트로 돌아가기
                </button>
    ...
    return (
        <div id="main">
            <style>{`
                ...
                .pro-items-blur {
                    filter:blur(30px) brightness(0.88);
                    pointer-events:none;
                    user-select:none;
                }
                ...
                <section id="resultPage" className="result-page" ref={reportRef}>
                    <div className="result-top" style={{ alignItems: "flex-start" }}>
                        <div className="rt-left">
                            ...
                            <p className="rt-sub">
                                업로드한 영상의 위변조/AI 생성 의심 구간을 종합 분석했습니다.
                            </p>
                        </div>
                                    ...
                                    {menuOpen && (
                                        <div className="hamburger-dropdown">
                                            ...
                                            <div
                                                ...
                                                onClick={() => {
                                                    setMenuOpen(false);
                                                    setShowFrameGraph(true);
                                                }}
                                            >
                                                <div className="menu-icon">📈</div>
                                                <div>
                                                    <div className="menu-label-blue">
                                                        프레임별 위조 의심도 그래프
                                                    </div>
                                            ...
                                            >
                                                <div className="menu-icon" style={{ background: "#f0fdf4" }}>
                                                    🕑
                                                </div>
                                                <div>
                    ...
                    <div className="card section-card">
                        ...
                        >
                            <div>
                                ...
                                <p className="hint" style={{ marginTop: 0 }}>
                                    총 {analysisData.timeline_chart.length}개 프레임 분석
                                </p>
                            </div>
                            ...
                            >
                                <span style={{ display: "flex", alignItems: "center", gap: 5, fontSize: 12, color: "#6b7280" }}>
                                    <em style={{ display: "inline-block", width: 10, height: 10, borderRadius: 2, background: "#E24B4A", fontStyle: "normal" }} />
                                    높음 (70%+)
                                </span>
                                <span style={{ display: "flex", alignItems: "center", gap: 5, fontSize: 12, color: "#6b7280" }}>
                                    <em style={{ display: "inline-block", width: 10, height: 10, borderRadius: 2, background: "#EF9F27", fontStyle: "normal" }} />
                                    중간 (50–69%)
                                </span>
                                <span style={{ display: "flex", alignItems: "center", gap: 5, fontSize: 12, color: "#6b7280" }}>
                                    <em style={{ display: "inline-block", width: 10, height: 10, borderRadius: 2, background: "#378ADD", fontStyle: "normal" }} />
                                    낮음 (50% 미만)
                                </span>
                            </div>
                        </div>
                        ...
                        >
                            <div style={{ background: "#f9fafb", borderRadius: 10, padding: 12, textAlign: "center" }}>
                                ...
                                <p style={{ fontSize: 20, fontWeight: 600, color: "#111827", margin: 0 }}>
                                    {inlineFrameStats.avg}%
                                </p>
                            </div>
                            <div style={{ background: "#f9fafb", borderRadius: 10, padding: 12, textAlign: "center" }}>
                                <p style={{ fontSize: 11, color: "#9ca3af", margin: "0 0 4px" }}>최고 의심 프레임</p>
                                <p style={{ fontSize: 20, fontWeight: 600, color: "#E24B4A", margin: 0 }}>
                                    Frame {inlineFrameStats.peakIdx}
                                </p>
                            </div>
                            <div style={{ background: "#f9fafb", borderRadius: 10, padding: 12, textAlign: "center" }}>
                                <p style={{ fontSize: 11, color: "#9ca3af", margin: "0 0 4px" }}>위험 구간 수</p>
                                <p style={{ fontSize: 20, fontWeight: 600, color: "#E24B4A", margin: 0 }}>
                                    {inlineFrameStats.dangerCount}구간
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="detail-item" key={`pub-${i}`}>
                                <div className="d-left">
                                    <div className="d-title">
                                        {item.title}{" "}
                                        <span className={`tag ${riskTag(item.risk_level)}`}>
                                            위험도: {item.risk_level}
                                        </span>
                                    </div>
